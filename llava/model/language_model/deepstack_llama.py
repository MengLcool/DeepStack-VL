...
from ..deepstack_arch import DeepstackMetaModel, DeepstackMetaForCausalLM
from .custom_llama import CustomLlamaModel, CustomLLlamaForCausalLM

class DeepstackConfig(LlamaConfig):
    model_type = "deepstack_llama"


class DeepstackLlamaModel(DeepstackMetaModel, CustomLlamaModel):
    config_class = DeepstackConfig

    def __init__(self, config: LlamaConfig):
        super(DeepstackLlamaModel, self).__init__(config)


class DeepstackLlamaForCausalLM(CustomLLlamaForCausalLM, DeepstackMetaForCausalLM):
    config_class = DeepstackConfig

    def __init__(self, config):
        super(LlamaForCausalLM, self).__init__(config)
        self.model = DeepstackLlamaModel(config)
...
AutoConfig.register("deepstack_llama", DeepstackConfig)
AutoModelForCausalLM.register(DeepstackConfig, DeepstackLlamaForCausalLM)
